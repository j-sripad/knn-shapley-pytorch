...
class ResNet(pl.LightningModule):
    ...
    def __init__(self, net="resnet18", n_classes=2, learning_rate=1e-3, feature_layer=5):
        ...
        self.features = nn.Sequential(*list(self.model.children())[:self.hparams.feature_layer])
